<?php
// --------FILENAME: admin-pages/admin-moveWaitlistEmail.php ---------
...
if ($emailEnabled) {
  ...
  $message = "Hello " . $first_name . " " . $last_name . " .\nWe have moved you from your waitlist into the "
    . $entree_name . " cuisine event that is on " . $event_date . " at " . $start_time . "-" . $end_time .
