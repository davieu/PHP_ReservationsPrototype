...
if ($emailEnabled) {
  ...
  $message = "Thank you " . $first_name . " " . $last_name . " for making a reservation with the WCC Culinary Program.\nThe dinner will be based on " . $dinnerInfoArray[0] . " dishes.\nThe event starts on " . $dinnerInfoArray[1] . " at " . $dinnerInfoArray[2] . "-" . $dinnerInfoArray[3] . ".\nYour total is $" . $reservation_total . " for " . $seats_reserved . " seat(s).\nIf you have any questions feel free to contact the business office.\nYour confirmation code: " . str_pad($last_id, 8, "0", STR_PAD_LEFT);
